    ...
    scenes: [
      {
        ...
        audio: require("../../assets/sounds/stories/handwash/scene1.mp3"),
      },
      {
        id: 2,
        video: require("../../assets/stories/handwash/scene2.mp4"),
        text: "أحمد يذهب إلى الحمام لغسل يديه ويدخل برجه الايسر ويقول بسم الله اللهم اني اعوذ بك من الخبث والخبائث",
        audio: require("../../assets/sounds/stories/handwash/scene2.mp3"),
      },
      {
        id: 3,
        video: require("../../assets/stories/handwash/scene3.mp4"),
        text: "يفتح أحمد صنبور الماء.",
        audio: require("../../assets/sounds/stories/handwash/scene3.mp3"),
      },
      {
        id: 4,
        video: require("../../assets/stories/handwash/scene4.mp4"),
        text: "يضع الصابون على يديه ويفركهما جيداً.",
        audio: require("../../assets/sounds/stories/handwash/scene4.mp3"),
      },
      {
        id: 5,
        video: require("../../assets/stories/handwash/scene5.mp4"),
        text: "يشطف أحمد يديه بالماء النظيف.",
        audio: require("../../assets/sounds/stories/handwash/scene5.mp3"),
      },
      {
        id: 6,
        video: require("../../assets/stories/handwash/scene6.mp4"),
        text: "يجفف أحمد يديه بالمنشفة. أحسنت يا أحمد!",
        audio: require("../../assets/sounds/stories/handwash/scene6.mp3"),
      },
    ],
    quiz: {
      question: "متى يجب أن نغسل اليدين؟",
      questionAudio: require("../../assets/sounds/quiz/handwash_question.mp3"),
      useTTS: false, // ✅ نستخدم الصوت المحلي
      options: [
        {
          id: "correct",
          text: "قبل الأكل",
    ...
    scenes: [
      {
        ...
        audio: require("../../assets/sounds/stories/sleep/scene1.mp3"),
      },
      {
        id: 2,
        video: require("../../assets/stories/sleep/scene2.mp4"),
        text: "عمر يرتب ألعابه.",
        audio: require("../../assets/sounds/stories/sleep/scene2.mp3"),
      },
      {
        id: 3,
        video: require("../../assets/stories/sleep/scene3.mp4"),
        text: "يذهب عمر لتنظيف أسنانه.",
        audio: require("../../assets/sounds/stories/sleep/scene3.mp3"),
      },
      {
        id: 4,
        video: require("../../assets/stories/sleep/scene4.mp4"),
        text: "يستلقي عمر في سريره ويقول دعاءالنوم بسمك اللهم اموت واحيا.",
        audio: require("../../assets/sounds/stories/sleep/scene4.mp3"),
      },
      {
        id: 5,
        video: require("../../assets/stories/sleep/scene5.mp4"),
        text: "تصبح على خير يا عمر. نوم هانئ!",
        audio: require("../../assets/sounds/stories/sleep/scene5.mp3"),
      },
    ],
    quiz: {
      question: "ماذا نفعل قبل النوم؟",
      questionAudio: require("../../assets/sounds/quiz/sleep_question.mp3"),
      useTTS: false, // ✅ نستخدم الصوت المحلي
      options: [
        {
          id: "correct",
